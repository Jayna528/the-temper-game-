...
var gameState = 0;
var word1, word1Image, word2, word2Image, word3, word3Image;
...
function preload(){
  ...
  word3Image = loadImage("text/text3.png");
...
function setup() {
  ...
  boy.addAnimation("dead" , boy_dead);
  boy.scale = 0.7;
  boy.visible = false;
...
function draw() {
  ...
  if(gameState == 3){
    ...
    button2 = createSprite(75,300,20,20);
  ...
  if(gameState == 5){
    background(kitchenBG);
    word3 = createSprite(370,350,10,10);
    word3.addImage(word3Image);
    boss.visible = true;
    boy.changeAnimation("dead" , boy_dead);
